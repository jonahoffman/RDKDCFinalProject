...
g_baseK_S = [ROTZ(-pi/2, false) [0 0 0.0892]'; 0 0 0 1];  %transformation from keating base to {S}
%-90 degree rotation around z and up x 0.0892 
baseKFrame = tf_frame('S','base_K',eye(4));
baseKFrame.move_frame('S',inv(g_baseK_S));

g_T_toolK = [ROTX(-pi/2, false)*ROTY(pi/2, false) [0 0 0]'; 0 0 0 1]; %transformation from {T} to keating tool 
